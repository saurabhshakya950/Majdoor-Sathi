...
const Notifications = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/notifications?userType=LABOUR`, {
                headers: {
    ...
    const markAllAsRead = async (silent = false) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/notifications/read-all`, {
                ...
                body: JSON.stringify({ userType: 'LABOUR' })
            });
    ...
    const deleteNotification = async (id) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/notifications/${id}?userType=LABOUR`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
