            ...
            try {
                ...
                if (response.success) {
                    ...
                    const transformedRequests = response.data.hireRequests.map(req => ({
                        ...
                        contractorPhone: req.contractorPhone,
                        contractorBusiness: req.contractorBusiness,
                        contractorCity: req.contractorCity,
                ...
                console.error('Failed to load contractor hire requests:', error);
                setRequests([]);
            } finally {
                setLoading(false);
            }
    ...
    const handleAccept = async (requestId) => {
        try {
            ...
            if (response.success) {
                ...
                // Trigger update in user panel
                window.dispatchEvent(new CustomEvent('contractor-hire-request-updated', {
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3 mb-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600">Wants to hire you</p>
                                    </div>
                                </div>
