...
const Requests = () => {
    ...
    const requestOptions = [
        {
            title: 'User Request',
            subtitle: 'View and manage requests from users',
            icon: Briefcase,
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 mx-4 mt-4 rounded-2xl shadow-lg">
                    ...
                    <div className="relative p-6 text-white">
                        ...
                        <h1 className="text-2xl font-bold mb-2">Manage Your Requests</h1>
                        <p className="text-blue-100 text-sm">Choose the type of request you want to handle</p>
                    </div>
                </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Manage your requests efficiently and grow your business
                                </p>
                            </div>
                        </div>
                    </div>
